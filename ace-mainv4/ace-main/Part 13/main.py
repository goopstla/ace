...
#individual turret image for mouse cursor
cursor_farm = pg.image.load('assets/images/turrets/idk.png').convert_alpha()
#enemies
image_size = (64, 64)  # Example size, adjust as needed

enemy_images = {
    "weak": pg.transform.scale(pg.image.load('assets/images/turrets/idk.png').convert_alpha(), image_size),
    "medium": pg.transform.scale(pg.image.load('assets/images/enemies/enemy_2.png').convert_alpha(), image_size),
    "strong": pg.transform.scale(pg.image.load('assets/images/enemies/enemy_3.png').convert_alpha(), image_size),
    "elite": pg.transform.scale(pg.image.load('assets/images/enemies/enemy_4.png').convert_alpha(), image_size)
}
#buttons
buy_turret_image = pg.image.load('assets/images/turrets/turret_moneyover.png').convert_alpha()
buy_turret_image = pg.transform.scale(buy_turret_image, (40, 65))
buy_farm_image = pg.image.load('assets/images/turrets/ribosome.png').convert_alpha()
buy_farm_image = pg.transform.scale(buy_farm_image, (40, 50))
...
#create buttons
turret_button = Button(c.SCREEN_WIDTH + 45, 120, buy_turret_image, True)
farm_button = Button(c.SCREEN_WIDTH + 100, 135, buy_farm_image, True)
...
while run:
  ...
  if game_over == False:
    ...
    # placing turrets when buypressed
