...
class Farm(pg.sprite.Sprite):
    def __init__(self, tile_x, tile_y, money_per_interval=200):
        ...
        self.image = pg.image.load('assets/images/turrets/ribosome.png').convert_alpha()  # Adjust the path as needed
        self.image = pg.transform.scale(self.image, (105, 105))
