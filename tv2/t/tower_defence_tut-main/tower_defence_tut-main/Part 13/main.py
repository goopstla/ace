...
#buttons
buy_turret_image = pg.image.load('assets/images/turrets/cursor_turret.png').convert_alpha()
...
farm_button = Button(c.SCREEN_WIDTH + 100, 130, buy_farm_image, True)
...
while run:
  ...
  if game_over == False:
    ...
    draw_text(str(c.BUY_COST), text_font, "yellow", c.SCREEN_WIDTH + 45, 115)
